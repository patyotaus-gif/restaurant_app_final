...
final Map<String, PaperSize> _paperSizeByKey =
    Map<String, PaperSize>.unmodifiable(<String, PaperSize>{
      'mm58': PaperSize.mm58,
      'mm80': PaperSize.mm80,
    });

String _paperSizeToStorageKey(PaperSize paper) {
  for (final MapEntry<String, PaperSize> entry in _paperSizeByKey.entries) {
    if (entry.value == paper) {
      return entry.key;
    }
  }
  return 'mm80';
...
PaperSize _paperSizeFromStorageKey(String? key) {
  ...
  return _paperSizeByKey[key] ?? PaperSize.mm80;
}
