...
void backgroundSyncDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    ...
    try {
      ...
      // Plugin registration callbacks are generated by Flutter tooling when
      // required. When running in environments such as unit tests the
      // callback may be null, so we defensively check before invoking it
      // to ensure plugins are registered prior to continuing.
      final pluginRegistrant = PluginUtilities.getPluginRegistrantCallback();
      pluginRegistrant?.call();
      // In other environments such as background isolates the
      // callback may be null, so we defensively ensure plugins are
