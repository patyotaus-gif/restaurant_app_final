...
void backgroundSyncDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    ...
    try {
      ...
      // The DartPluginRegistrant is generated by Flutter tooling when building
      // for platforms that require plugin registration. At analysis time the
      // symbol may be undefined, so the ignore above suppresses warnings while
      // keeping the invocation for runtime execution where it is available.
